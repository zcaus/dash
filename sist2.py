...
def create_value_bar_chart(df):
    # Remove o símbolo de moeda e os separadores de milhar, depois converte para numérico
    df['Valor Total Numérico'] = df['Valor Total'].replace({'R\$': '', ',': ''}, regex=True).astype(float)
